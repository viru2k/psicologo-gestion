...
@Component({
  selector: 'app-asuntosprofesionales',
  templateUrl: './asuntosprofesionales.component.html',
  styleUrls: ['./asuntosprofesionales.component.scss']
})
export class AsuntosprofesionalesComponent implements OnInit {
